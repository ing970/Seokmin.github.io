...
- 프로그램 실행시 언어
    ...
    ![Alt text](../assets/images/playdata/ch01_01.png){: width="60%"",height="40%""}
...
![Alt text](../assets/images/playdata/ch01_02.png){: width="60%"",height="40%""}    

# 2. Python(파이썬) 
![Alt text](../assets/images/playdata/ch01_python_logo.png){: width="60%"",height="40%""}
...
- 파이썬 3rd party Library들의 저장소
    ...
    - https://pypi.org/
        - 패키지 검색 사이트
 ![Alt text](../assets/images/playdata/image_3.png)
...
![Alt text](../assets/images/playdata/image_3_1.png)
